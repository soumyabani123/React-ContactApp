...
const About = () => {
    return (
        <div className="container">
            <div className="py-4">
                <h1>About Page</h1>
                <p className="lead">A well-organized paragraph supports or develops a single controlling idea, 
                ...
                That’s why it’s often best to put the topic sentence at the very beginning of the paragraph.
                 ...
                 a sentence linking the current paragraph to the previous one, or one providing background information.</p>
                 
                <p className="lead">Although most paragraphs should have a topic sentence, there are a few situations when a paragraph might not need a topic sentence. 
                For example, you might be able to omit a topic sentence in a paragraph that narrates a series of events, 
                if a paragraph continues developing an idea that you introduced (with a topic sentence) in the previous paragraph,
